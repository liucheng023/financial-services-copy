...
- 新增 Web 前端应用（Next.js 14 App Router + TypeScript + Tailwind + shadcn/ui + TanStack Query + Zustand，pnpm），包含对话页、Agent 列表/详情、技能包列表/详情、MCP 管理、系统配置、聊天记录等页面
...
- **依赖**: FastAPI、Next.js 14 (App Router)、Supabase、mcp-use、OpenAI SDK
